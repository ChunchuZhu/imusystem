...
if __name__ == '__main__':
    ...
    file_name = "/Users/chunchu/My Drive/[3] Rutgers/[1] Research/[2] On-going Project/[1] IntentionRecognition+Control/Siyu's Work/Real-time-gait-detection/Data/" + "data-" + timestr + ".txt"
        ...
        while True:
            ...
            if vicon_enable:
                ...
                if vicon_data_flat[0] and IMU_data[0]:
                    print("%10.4f, %10.4f, %10.4f, %10.4f, %10.4f, %10.4f, %10.4f" % (current_period, IMU_data[3], IMU_data[17], IMU_data[31], IMU_data[45], IMU_data[59], vicon_data_flat[0]))
            else:
                data_record.extend(IMU_data)
                if IMU_data[0]:
                    # IMU_data size:70
                    # 0-13; 14-27; 28-41; 42-55; 56-69
                    print("%10.4f, %10.4f, %10.4f, %10.4f, %10.4f, %10.4f" % (current_period , IMU_data[3], IMU_data[17], IMU_data[31], IMU_data[45], IMU_data[59],))
